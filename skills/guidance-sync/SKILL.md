...
단, 현재 저장소 자체가 원본 제공자가 관리하는 `blue09040-afk/m1-starter`인 경우에는 `blue09040-afk/m1`의 **이미 병합된 공개·재사용 가능한 변경**을 선택적 upstream으로 대조할 수 있다. 반영은 별도 starter PR로 수행하며, 이 예외는 템플릿을 복제한 제3자 저장소에 자동 upstream 관계를 만들지 않는다.
